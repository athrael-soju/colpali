...
def parse_args():
    ...
    p.add_argument("--output-dir", type=str, default="./output/9", help="where to write model + script copy")
...
if __name__ == "__main__":
    ...
    config = ColModelTrainingConfig(
        ...
        tr_args=TrainingArguments(
            ...
            per_device_train_batch_size=64,  # Optimal for RTX 5090 32GB
            # gradient_accumulation_steps=4,   # Effective batch size = 128
            gradient_checkpointing=True,
            gradient_checkpointing_kwargs={"use_reentrant": False},
            per_device_eval_batch_size=32,   # Match training batch size
            eval_strategy="steps",
            dataloader_num_workers=8,       # Increase workers for faster data loading
            ...
            warmup_ratio=0.05,              # Optimal warmup based on architecture analysis
            ...
            optim="paged_adamw_8bit",      # Keep fused optimizer
