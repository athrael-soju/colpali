...
class ColQwen3(Qwen3VLModel):
    """
    ColQwen3 model implementation, following the architecture from the "ColPali: Efficient Document Retrieval
    with Vision Language Models" paper. Based on the Qwen3-VL backbone.

    Args:
        config (Qwen3VLConfig): The model configuration.
        mask_non_image_embeddings (Optional[bool]): Whether to ignore all token embeddings
